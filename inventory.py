    ...
    def parse_terraform(self):
        ...
        for entry in terraform_data:
            ...
            if entry == 'bootstrap_public_ips':
                ...
                self.push_var(self.inventory, 'bootstraps', {'node_type': 'bootstrap'})
            ...
            # Add group masters
                ...
                self.push_var(self.inventory, 'masters', {'node_type': 'master'})
                self.push_var(self.inventory, 'masters', {'dcos_legacy_node_type_name': 'master'})

            # Add group agents_private
            elif entry == 'agent_public_ips':
                self.push_hosts(self.inventory, 'agents_private', terraform_data['agent_public_ips']['value'])
                self.push_child(self.inventory, 'common', 'agents')
                self.push_child(self.inventory, 'agents', 'agents_private')
                self.push_var(self.inventory, 'agents_private', {'node_type': 'agent'})
                self.push_var(self.inventory, 'agents_private', {'dcos_legacy_node_type_name': 'slave'})
            ...
            # Add group public agents
                ...
                self.push_child(self.inventory, 'common', 'agents')
                self.push_child(self.inventory, 'agents', 'agents_public')
                self.push_var(self.inventory, 'agents_public', {'node_type': 'agent_public'})
                self.push_var(self.inventory, 'agents_public', {'dcos_legacy_node_type_name': 'slave_public'})
            ...
            # Add variables
                ...
                self.push_var(self.inventory, 'agents_public', {"ansible_user": terraform_data['public_agents_admin_username']['value']})

            elif entry == 'private_agents_admin_username':
                self.push_var(self.inventory, 'agents_private', {"ansible_user": terraform_data['private_agents_admin_username']['value']})
